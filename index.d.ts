declare interface autofit {
   ...
   * - transition（可选）：过渡时间，默认是 0.6
   * - delay（可选）：默认是 1000
  */
  init(options: { renderDom: String, designWidth: Number, designHeight: Number, resize: Boolean, ignore: Array<Object>, transition: Number, delay: Number }): void;
  /**
   * @param {String} id 
   * 关闭autofit.js造成的影响
   * 
